...
<div>
	...
	>
			...
			<div class="mb-4 flex space-x-4">
				<div class="relative flex-1">
					<input
						...
						id="adults"
						name="adults"
						class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-gray-500 focus:outline-none focus:ring-gray-500 sm:text-sm"
					/>
					<span class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500">Adults</span
					>
				</div>
				<div class="relative flex-1">
					<input
						...
						class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-gray-500 focus:outline-none focus:ring-gray-500 sm:text-sm"
					/>
					<span class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-500">Kids</span>
				</div>
			</div>
		</div>
		<div class="mb-4">
		...
		<div class="mb-4">
			<label for="date" class="block text-sm font-medium text-gray-700">Are you a Sevaka ?</label>
			<!-- selwct with yes or no -->
			<select
				id="sevaka"
				name="sevaka"
				class="mt-1 block
